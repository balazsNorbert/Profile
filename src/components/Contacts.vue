  ...
  <div class="w-full text-white flex justify-center mb-14">
    <ul class="flex flex-col xl:flex-row justify-between gap-3 xl:gap-10 text-sm md:text-xl lg:text-2xl">
      <li class="flex items-center gap-2 md:gap-3">
        <span class="material-icons text-white text-4xl md:text-5xl">
          phone
        </span>
        <button ref="contact1" @click="copyToClipboard( '1' )" class="bg-sky-600 shadow-xl text-white py-2 px-3 rounded-lg hover:bg-sky-300
      ...
      <li class="flex items-center gap-2 md:gap-3">
        <span class="material-icons-outlined text-white text-4xl md:text-5xl">
          email
        </span>
        <button ref="contact2" @click="copyToClipboard( '2' )" class="bg-sky-600 shadow-xl text-white py-2 px-3 rounded-lg hover:bg-sky-300
      ...
      <li class="flex items-center gap-2 md:gap-3">
        <img class="w-9 h-9 md:w-12 md:h-12 text-white" src="../assets/svg/linkedin-brands-solid.svg" alt="Linkedin image">
        <a href="https://www.linkedin.com/in/bal%C3%A1zs-norbert-a17313261/" class="bg-sky-600 shadow-xl text-white py-2 px-3 rounded-lg hover:bg-sky-300
                    focus:outline-none focus:ring-2 focus:ring-indigo-300 truncate ...">
          {{ $t( 'linkedin' ) }}
        </a>
      </li>
