<template>
  <div class="flex flex-col gap-8 px-6 py-12 bg-sky-200 font-lexend text-white">
    ...
    <div class="flex flex-col gap-4 overflow-hidden">
        <h3 class="text-xl font-bold text-teal-600">Frontend Development</h3>
        <ul class="grid grid-cols-2 md:grid-cols-3 gap-4 text-lg">
            <li class="bg-gradient-to-b from-teal-600 to-teal-400 p-3 rounded-lg">HTML</li>
            <li class="bg-gradient-to-b from-teal-600 to-teal-400 p-3 rounded-lg">CSS</li>
            <li class="bg-gradient-to-b from-teal-600 to-teal-400 p-3 rounded-lg">JavaScript</li>
            <li class="bg-gradient-to-b from-teal-600 to-teal-400 p-3 rounded-lg">React.js</li>
            <li class="bg-gradient-to-b from-teal-600 to-teal-400 p-3 rounded-lg">Vue.js</li>
            <li class="bg-gradient-to-b from-teal-600 to-teal-400 p-3 rounded-lg">Angular</li>
            <li class="bg-gradient-to-b from-teal-600 to-teal-400 p-3 rounded-lg">TypeScript</li>
            <li class="bg-gradient-to-b from-teal-600 to-teal-400 p-3 rounded-lg">JQuery</li>
        </ul>
    </div>

    <div class="flex flex-col gap-4">
        <h3 class="text-xl font-bold text-indigo-600">Backend Development</h3>
        <ul class="grid grid-cols-2 md:grid-cols-3 gap-4 text-lg">
            <li class="bg-gradient-to-b from-indigo-600 to-indigo-400 p-3 rounded-lg">Node.js</li>
            <li class="bg-gradient-to-b from-indigo-600 to-indigo-400 p-3 rounded-lg">PHP</li>
            <li class="bg-gradient-to-b from-indigo-600 to-indigo-400 p-3 rounded-lg">Laravel</li>
            <li class="bg-gradient-to-b from-indigo-600 to-indigo-400 p-3 rounded-lg">Livewire</li>
            <li class="bg-gradient-to-b from-indigo-600 to-indigo-400 p-3 rounded-lg">Express.js</li>
            <li class="bg-gradient-to-b from-indigo-600 to-indigo-400 p-3 rounded-lg">TypeScript</li>
        </ul>
    </div>

    <div class="flex flex-col gap-4">
      <h3 class="text-xl font-bold text-purple-600">Databases</h3>
      <ul class="grid grid-cols-2 md:grid-cols-3 gap-4 text-lg">
        <li class="bg-gradient-to-b from-purple-600 to-purple-400 p-3 rounded-lg">MySQL</li>
        <li class="bg-gradient-to-b from-purple-600 to-purple-400 p-3 rounded-lg">MariaDB</li>
        <li class="bg-gradient-to-b from-purple-600 to-purple-400 p-3 rounded-lg">Oracle</li>
        <li class="bg-gradient-to-b from-purple-600 to-purple-400 p-3 rounded-lg">MongoDB</li>
      </ul>
    </div>

    <div class="flex flex-col gap-4">
      <h3 class="text-xl font-bold text-yellow-600">Other Skills</h3>
      <ul class="grid grid-cols-2 md:grid-cols-3 gap-4 text-lg">
        <li class="bg-gradient-to-b from-yellow-600 to-yellow-400 p-3 rounded-lg">Git</li>
        <li class="bg-gradient-to-b from-yellow-600 to-yellow-400 p-3 rounded-lg">Github</li>
        <li class="bg-gradient-to-b from-yellow-600 to-yellow-400 p-3 rounded-lg">Bitbucket</li>
        <li class="bg-gradient-to-b from-yellow-600 to-yellow-400 p-3 rounded-lg">Docker</li>
        <li class="bg-gradient-to-b from-yellow-600 to-yellow-400 p-3 rounded-lg">SEO principles</li>
      </ul>
    </div>
  </div>
</template>
